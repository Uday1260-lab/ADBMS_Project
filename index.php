...
<html lang="en">
    ...
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg bg-custom text-uppercase fixed-top" id="mainNav">
            <div class="container">
    ...
    <!-- Masthead Avatar Image - takes 50% width -->
    ...
    <div class="w-50 d-flex justify-content-center align-items-center">
        <img class="masthead-avatar mb-5" src="./assets/img/homepage.png" alt="..." />
    </div>
