...
if(isset($_POST['submit']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update tblcategory set VehicleCat='$catname', ParkingCharge='$parkingcharge' where ID='$eid'");
    if ($query) {
...
?>              
    ...
    <input type="text" name="parkingcharge" id="parkingcharge" value="<?php echo $row['ParkingCharge']; ?>" class="form-control" required>
</div>
