...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblcategory(VehicleCat, ParkingCharge) value('$catname', '$parkingcharge')");
    if ($query) {
...
<body>
   ...
   <?php include_once('includes/header.php');?>
    ...
    <input type="text" name="parkingcharge" id="parkingcharge" class="form-control" required>
</div>
