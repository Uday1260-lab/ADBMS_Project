                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <table class="table mb-0">
                                        <tr>
                                            <th>Remark:</th>
                                            <td>
                                                <textarea name="remark" placeholder="" rows="6" cols="14" class="form-control" required="true"><?php echo $row['Remark']; ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Parking Charge:</th>
                                            <td>
                                                <input type="text" name="parkingcharge" id="parkingcharge" class="form-control" value="<?php echo $row['ParkingCharge']; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Status:</th>
